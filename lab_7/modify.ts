export namespace Transport {
    ...
    export class VehicleImpl implements Vehicle {
        ...
        getShortInfo(): string {
            const ownerFullName = `${this._Owner.LastName} ${this._Owner.FirstName} ${this._Owner.MiddleName}`;
            return `VIN: ${this._VINNumber}, Владелец: ${ownerFullName}, Рег. номер: ${this._RegistrationNumber}`;
        }
    }
